...
function atelierFromRow(r) {
  return {
    id: r.id,
    kind: safeText(r.kind) || "catalogue",
    ...
    heureFin: safeText(r.heure_fin),
    libelle: safeText(r.libelle),
    intervenant: safeText(r.intervenant),
    modeRemuneration: safeText(r.mode_remuneration),
    montantSuzanne: safeNumberField(r.montant_suzanne),
    remunerationTaux: safeNumberField(r.remuneration_taux),
    prixPublicParticipant: safeNumberField(r.prix_public_participant),
    statut: safeText(r.statut) || "Prévu",
...
function atelierToRow(a) {
  return {
    id: a.id,
    kind: a.kind || "catalogue",
    catalogue_id: a.catalogueId || null,
    nom: a.nom || null,
    type_activite: a.typeActivite || null,
    categorie: a.categorie || null,
    photo_path: a.photoPath || null,
    description: a.description || null,
    duree_min: a.dureeMin === "" || a.dureeMin == null ? null : Number(a.dureeMin),
    places_max: a.placesMax === "" || a.placesMax == null ? null : Number(a.placesMax),
    theme: a.theme,
    date: a.date,
    heure: a.heure || null,
    heure_fin: a.heureFin || null,
    libelle: a.libelle || null,
    intervenant: a.intervenant || null,
    mode_remuneration: a.modeRemuneration || null,
    montant_suzanne: a.montantSuzanne === "" || a.montantSuzanne == null ? null : Number(a.montantSuzanne),
    remuneration_taux: a.remunerationTaux === "" || a.remunerationTaux == null ? null : Number(a.remunerationTaux),
    prix_public_participant: a.prixPublicParticipant === "" || a.prixPublicParticipant == null ? null : Number(a.prixPublicParticipant),
